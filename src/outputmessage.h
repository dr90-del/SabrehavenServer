...
// Delay for batching sends
static constexpr std::chrono::milliseconds OUTPUTMESSAGE_AUTOSEND_DELAY{10};
...
public:
    ...
    // allocate exactly one OutputMessage (std::make_shared only ever asks for 1)
